...
const ChallengeHomeCard = ({
  ...
  return (
    <Link href={`/challenge/${item.challenge_id}`} className={cn("shadow-xl rounded-md max-md:w-76 md:min-w-96 bg-white ")}>
      <div>
        <div className="block">
          <div className="p-3 space-y-3 flex rounded border items-center px-3 gap-3 min-w-72 w-full">
            ...
            <div className="w-full">
              <div className="w-full flex justify-between items-center">
                ...
                {item?.success && (
                  <div className={cn("rounded-full ", item.success == "yes" ? "bg-green-600" : "bg-red-600")}>
