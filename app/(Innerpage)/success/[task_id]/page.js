            ...
            pageTypes !== "language" && (
              <p className=" text-black/80 p-3 text-center">
                {percentageDetails > 34.99 ? (
                  <>Congratulations! You have successfully completed the first round and are eligible for the next round.</>
                ) : (
                  <>Unfortunately, you did not complete the first round. You are ineligible for the next round.</>
                )}
              </p>
            )}
